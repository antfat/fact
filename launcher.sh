...
CADO_CLIENT_URL="https://raw.githubusercontent.com/cado-nfs/cado-nfs/2.3.0/scripts/cado-nfs-client.py"
...
wget -O /cado-nfs/cado-nfs-client.py "$CADO_CLIENT_URL" || true
